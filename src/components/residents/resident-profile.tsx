                ...
                {medications.map((medication) => (
                  <div key={medication.id} className="p-4 border rounded-lg">
                    <div className="flex justify-between items-start">
                      ...
                      <div className="text-sm text-muted-foreground">
                        Started: {format(new Date(medication.startDate), 'dd/MM/yyyy')}
                      </div>
                    </div>
                  </div>
                ))}
              ...
              <div className="space-y-3">
                {observations.map((obs) => (
                  <div key={obs.id} className="flex items-center justify-between p-3 border rounded-lg">
                    <div>
                      <div className="font-medium">{obs.type}</div>
                      <div className="text-sm text-muted-foreground">
                        {obs.value} {obs.unit}
                      </div>
                      <div className="text-xs text-muted-foreground">
                        {format(new Date(obs.recordedAt), 'dd/MM/yyyy HH:mm')} by {obs.recordedBy}
                      </div>
                    </div>
                    {obs.thresholdFlag && (
